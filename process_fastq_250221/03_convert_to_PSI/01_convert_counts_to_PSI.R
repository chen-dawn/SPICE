...
write_csv(all_possible_included_events, "U:/melange/process_fastq_250221/03_convert_to_PSI/WT_all_included_events.csv")
...
all_files_df <- fread("U:/processed_data/reprocess_250221/count_normalized_chimeric_rate_considering_included/WT_all_samples_raw_counts.csv")
setDT(all_files_df)
...
# Write to file
fwrite(final_psi_table, "U:/processed_data/reprocess_250221/count_normalized_chimeric_rate_considering_included/WT_all_samples_PSI_count_table.csv")
