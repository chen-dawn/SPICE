...
output_filepath <- "C:/Users/dawnxi/Dropbox (Harvard University)/02Splicing/SplicingManuscript/figure_outputs/OEx"
...
ggsave(filename = file.path(output_filepath, "all_samples_violin_plot_new_data_all_offset.pdf"), plot = p1, width = 12, height = 6, dpi = 300)
...
ggsave(file.path(output_filepath,"CrossReplicate_Correlation_Heatmap_new_data_all_offset.pdf"), plot = p2, dpi = 300, width = 17, height = 16)
