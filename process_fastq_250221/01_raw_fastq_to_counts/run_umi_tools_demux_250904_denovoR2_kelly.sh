...
# Job name
#$ -N Nova250904_denovoR2_kelly_UMI_TOOLS
...
#     echo $filename
#     qsub -v FILENAME=$filename /broad/dawnccle/melange/process_fastq_250221/01_raw_fastq_to_counts/run_umi_tools_demux_250904_denovoR2_kelly.sh
# done
