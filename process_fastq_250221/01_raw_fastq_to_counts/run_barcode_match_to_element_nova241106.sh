...
# Job name
#$ -N Nova241106MatchBarcodeToElement
...
# Run like:
# cd /broad/dawnccle/sequencing/241106_Novaseq
# for filename in *_R1_bc_extracted.fastq.gz; do
#     echo $filename
#     qsub -v FILENAME=$filename /broad/dawnccle/melange/process_fastq_250221/01_raw_fastq_to_counts/run_barcode_match_to_element_nova241106.sh
# done


outdir=/broad/dawnccle/processed_data/reprocess_250221/nova241106
indir=/broad/dawnccle/sequencing/241106_Novaseq
mkdir -p $outdir
