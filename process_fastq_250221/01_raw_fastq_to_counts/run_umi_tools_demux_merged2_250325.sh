...
# Run like
# cd /broad/dawnccle/sequencing/merged_all2
# for filename in *_merged_R1_001.fastq.gz; do
#     echo $filename
#     qsub -v FILENAME=$filename /broad/dawnccle/melange/process_fastq_250221/01_raw_fastq_to_counts/run_umi_tools_demux_merged2_250325.sh
# done

outdir=/broad/dawnccle/processed_data/reprocess_250221/merged_250325
indir=/broad/dawnccle/sequencing/merged_all2
mkdir -p $outdir
