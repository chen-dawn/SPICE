...
# Run like
# cd /broad/dawnccle/sequencing/251113_A549
# for filename in A549*_R1_001.fastq.gz; do
#     echo $filename
#     qsub -v FILENAME=$filename /broad/dawnccle/melange/process_fastq_250221/01_raw_fastq_to_counts/run_umi_tools_demux_251113_A549.sh
# done

outdir=/broad/dawnccle/processed_data/reprocess_250221/251113_A549
indir=/broad/dawnccle/sequencing/251113_A549
mkdir -p $outdir
