...
# while read p; do
#     echo $p
#     qsub -v FILENAME=$p /broad/dawnccle/scripts_splicing_library/run_umi_tools_demux.sh
# done < merged_R1_filelist.txt

# R1 filenames list for IPC298 only.
# for filename in IPC298*_merged_R1_001.fastq.gz; do
#     echo $filename
#     qsub -v FILENAME=$filename /broad/dawnccle/scripts_splicing_library/run_umi_tools_demux.sh
# done
...
python /broad/thechenlab/Dawn/splicing/library_sequencing_47k/MatchBarcodeToElementRNA_umi_tools_extracted_47k_R1_VCP_230524.py \
    ...
    -o /broad/dawnccle/processed_data/celltype47_240216_merged


# for FILENAME in [A-D]*_R1_001.fastq.gz; do
#     echo $FILENAME
