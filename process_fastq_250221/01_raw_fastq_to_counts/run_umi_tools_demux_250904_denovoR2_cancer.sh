...
# Job name
#$ -N Nova250904_denovoR2_cancer_UMI_TOOLS
...
# Run like
# cd /broad/dawnccle/sequencing/250904_denovo_R2
# for filename in CANCER*_R1_001.fastq.gz; do
#     echo $filename
#     qsub -v FILENAME=$filename /broad/dawnccle/melange/process_fastq_250221/01_raw_fastq_to_counts/run_umi_tools_demux_250904_denovoR2_cancer.sh
# done

outdir=/broad/dawnccle/processed_data/reprocess_250221/denovoR2_cancer
indir=/broad/dawnccle/sequencing/250904_denovo_R2
mkdir -p $outdir
...
umi_tools extract --stdin $FQ1 --read2-in=${FQ2}  \
    ...
    --whitelist /broad/thechenlab/Maile/splicing/mutagenesis_library/library_cancer_specific/250718_twist_library_cancer_revcomp_barcodes.txt  \
...
python /broad/thechenlab/Maile/splicing/sat_mut_scripts/MatchBarcodeToElementRNA_250703_no_mappy.py \
    ...
    -l /broad/thechenlab/Maile/splicing/mutagenesis_library/library_cancer_specific/250718_twist_library_cancer_barcodes.csv \
    -o $outdir