...
output_dir=/broad/dawnccle/processed_data/reprocess_250221/pairadise_indiv_PSI/MUT_$celltype1\_$celltype2
output_file=/broad/dawnccle/processed_data/reprocess_250221/pairadise_indiv_PSI/MUT_$celltype1\_$celltype2/$celltype1\_$celltype2\_formatted_df.tsv

mkdir -p $output_dir
Rscript /broad/dawnccle/melange/process_fastq_250221/04_run_pairadise/pairadise_PSI_MUT.R $celltype1 $celltype2 $output_file
