...
output_dir=/broad/dawnccle/processed_data/reprocess_250221/pairadise_indiv_altSS/WT_$celltype1\_$celltype2
output_file=/broad/dawnccle/processed_data/reprocess_250221/pairadise_indiv_altSS/WT_$celltype1\_$celltype2/$celltype1\_$celltype2\_formatted_df.tsv

mkdir -p $output_dir
Rscript /broad/dawnccle/melange/process_fastq_250221/04_run_pairadise/pairadise_altSS_WT_one_to_all.R $celltype1 $celltype2 $output_file
