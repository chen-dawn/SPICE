...
out_dir <- "/broad/dawnccle/processed_data/reprocess_250221/count_normalized_v4/"
# Create outdir.
dir.create(out_dir, showWarnings = FALSE)


# First we look at all the samples that are available. 
input_dir1 <- "/broad/dawnccle/processed_data/reprocess_250221/nova230516/"
input_dir2 <- "/broad/dawnccle/processed_data/reprocess_250221/nova240826/"
input_dir3 <- "/broad/dawnccle/processed_data/reprocess_250221/nova241106/"
input_dir4 <- "/broad/dawnccle/processed_data/reprocess_250221/K562/"
input_dir5 <- "/broad/dawnccle/processed_data/reprocess_250221/nova250313/"
input_dir6 <- "/broad/dawnccle/processed_data/reprocess_250221/merged_250325/"
...
merge_offsets_to_ref_parallel <- function(df, workers = 32) {
...
for (sample_tmp in unique_sample_names[221:length(unique_sample_names)]){
