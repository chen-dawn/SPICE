...
The DC297 vector was digested with **BsmBI**, and the library oligo pool was cloned into the plasmid using **Gibson assembly**. A representative library element is provided in `SAMPLE_library_element.gb`. The assembled library was transformed at sufficient coverage to ensure representation, generating the intermediate plasmid library `SAMPLE_final_plasmid_after_step1_cloning-DC297.gb`.
