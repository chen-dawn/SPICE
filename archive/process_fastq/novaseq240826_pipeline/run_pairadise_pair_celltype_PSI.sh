...
output_dir=/broad/dawnccle/processed_data/missplicing_processed_df/novaseq240826/pairadise_indiv_PSI/$celltype1\_$celltype2
output_file=/broad/dawnccle/processed_data/missplicing_processed_df/novaseq240826/pairadise_indiv_PSI/$celltype1\_$celltype2/$celltype1\_$celltype2\_formatted_df.tsv

mkdir -p $output_dir
Rscript /broad/dawnccle/melange/process_fastq/novaseq240826_pipeline/pairadise_PSI_celltype.R $celltype1 $celltype2 $output_file
