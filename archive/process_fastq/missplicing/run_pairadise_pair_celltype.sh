...
output_dir=/broad/dawnccle/processed_data/missplicing_processed_df/V5/pairadise_out/$celltype1\_$celltype2
output_file=/broad/dawnccle/processed_data/missplicing_processed_df/V5/pairadise_out/$celltype1\_$celltype2/$celltype1\_$celltype2\_formatted_df.tsv

mkdir -p $output_dir
Rscript /broad/dawnccle/melange/process_fastq/missplicing/pairadise_indiv_reps.R $celltype1 $celltype2 $output_file
