...
output_dir=/broad/dawnccle/processed_data/missplicing_processed_df/V5/tissue_type/$celltype1\_$celltype2
output_file=/broad/dawnccle/processed_data/missplicing_processed_df/V5/tissue_type/$celltype1\_$celltype2/$celltype1\_$celltype2\_formatted_df_lineage.tsv

mkdir -p $output_dir
Rscript /broad/dawnccle/melange/process_fastq/missplicing/pairadise_indivi_reps_tissuetype.R $celltype1 $celltype2 $output_file
