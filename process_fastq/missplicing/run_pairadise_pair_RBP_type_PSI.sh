...
echo $gene
output_dir=/broad/dawnccle/processed_data/missplicing_processed_df/V6/RBP_type_PSI_broad/$gene
output_file=/broad/dawnccle/processed_data/missplicing_processed_df/V6/RBP_type_PSI_broad/$gene/$gene\_formatted_df_lineage.tsv

mkdir -p $output_dir
Rscript /broad/dawnccle/melange/process_fastq/missplicing/pairadise_PSI_RBP_type.R $gene $output_file
