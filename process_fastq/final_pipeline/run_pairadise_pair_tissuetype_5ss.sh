...
output_dir=/broad/dawnccle/processed_data/latest/rmats_tissue_type_5ss/$celltype1\_$celltype2
output_file=/broad/dawnccle/processed_data/latest/rmats_tissue_type_5ss/$celltype1\_$celltype2/$celltype1\_$celltype2\_formatted_df_lineage.tsv

mkdir -p $output_dir
Rscript /broad/dawnccle/melange/process_fastq/final_pipeline/pairadise_tissuetype_5ss.R $celltype1 $celltype2 $output_file
